...
#
get_filename_component(filename "/app/astra/mongoclient/build/_deps/mongo_cxx_driver-subbuild/mongo_cxx_driver-populate-prefix/src/mongo-cxx-driver-r4.1.4.tar.gz" ABSOLUTE)
get_filename_component(directory "/app/astra/mongoclient/build/_deps/mongo_cxx_driver-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-mongo_cxx_driver-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-mongo_cxx_driver-populate${i}")
