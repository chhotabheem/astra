...
TEST_F(ContextExtendedTest, TraceparentParsingInvalid) {
    ...
    // Invalid version
    auto ctx2 = obs::Context::from_traceparent("01-00000000000000000000000000000000-0000000000000000-00");
    EXPECT_FALSE(ctx2.is_valid());
    
    // Missing delimiters
    auto ctx3 = obs::Context::from_traceparent("00000000000000000000000000000000000000000000000000000");
